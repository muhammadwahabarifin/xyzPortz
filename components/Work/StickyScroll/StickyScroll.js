...
const StickyScroll = ({ contentItems }) => {
  ...
  const cardLength = contentItems.lenght;
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-0 right-0 h-14 bg-gradient-to-b from-black to-transparent rounded-2xl z-10" />
      <div className="absolute bottom-0 left-0 right-0 h-14 bg-gradient-to-t from-black to-transparent rounded-2xl z-10" />
      ...
      <motion.div
        ...
        className="h-[22rem] flex justify-center space-x-10 p-4 rounded-2xl outline outline-gray-dark-1 overflow-y-auto no-scrollbar"
      >
